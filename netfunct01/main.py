...
def commandpush(devicecmd): # devicecmd==dict
    ...
    for ip in devicecmd.keys(): # looping through the dict
        print(f'{crayons.green("Handshaking")}. .. ... connecting with {ip}') # fstring with GREEN
...
def main():
    ...
    print(f"Welcome to the {crayons.yellow('Network')} Device Command Pusher") # welcome message with yellow text
